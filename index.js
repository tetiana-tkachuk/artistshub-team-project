import{a as v,i as d,R,S as $}from"./assets/vendor-CJJRgr2I.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const C=10,g=8,N="https://sound-wave.b.goit.study/api",y={GENRES:"/genres",ARTISTS:"/artists",ARTIST_BY_ID:"/artists/",FEEDBACKS:"/feedbacks"};v.defaults.baseURL=N;async function O(){const{data:e}=await v.get(`${y.FEEDBACKS}?limit=${C}&page=1`);return e}async function I(e){const{data:s}=await v.get(`${y.ARTISTS}?limit=${g}&page=${e}`);return s}const w="/artistshub-team-project/assets/sprite-Bwwhuc7H.svg";function x(e){const s=Math.floor(e/6e4),t=Math.floor(e%6e4/1e3);return`${s}:${t.toString().padStart(2,"0")}`}function j(e){return e.intDiedYear===null?`${e.intFormedYear} - present`:`${e.intFormedYear} - ${e.intDiedYear}`}function P(e){return e.strBiographyEN.split(".").slice(0,2).join(".")+"."}function Q(e){return e.genres.map(s=>`
    <li>
      <button class="artist-short-info-genre-btn">${s}</button>
    </li>`).join("")}function Y(e){return e.albumsList.map(t=>{const o=t.tracks.map(r=>{const n=r.movie===null?"":`
    ...
    z-index: 999;
`,t.appendChild(s),(e.style.position===""||e.style.position==="static")&&(e.style.position="relative"),e.appendChild(t),t}function F(e){const s=document.querySelector(e);return U(s)}function k(e){e&&(e.style.display="flex")}function M(e){e&&(e.style.display="none")}function h(e,s="success"){const t={message:e,position:"topRight",timeout:5e3};switch(s){case"success":d.success(t);break;case"error":d.error(t);break;case"warning":d.warning(t);break;case"info":d.info(t);break;default:d.error({message:`Invalid type of toast: ${s}`,position:"topRight",timeout:5e3});break}}const i={list:document.querySelector(".js-artists-list"),loadMoreBtn:document.querySelector(".js-artists-load"),modalOverlay:document.querySelector(".modal-overlay"),modalRoot:document.querySelector(".modal")},A=F("body");let m=1,p=!1,b=!1;i.list&&i.loadMoreBtn&&K();function K(){i.list.innerHTML="",i.loadMoreBtn.hidden=!0,i.loadMoreBtn.disabled=!1,b=!1,i.loadMoreBtn.addEventListener("click",G),i.list.addEventListener("click",J),T(!0)}async function G(){p||(m+=1,await T(!1))}async function T(e){if(!p){p=!0,e&&(m=1),i.loadMoreBtn.hidden=!0,i.loadMoreBtn.disabled=!0,i.loadMoreBtn.setAttribute("aria-busy","true"),k(A);try{const s=await I(m),t=(s==null?void 0:s.artists)??[];e&&(i.list.innerHTML=""),i.list.insertAdjacentHTML("beforeend",t.map(H).join(""));const o=X(s,m,g,t.length);i.loadMoreBtn.hidden=!o,!o&&!b&&(h("No more artists to load.","info"),b=!0)}catch(s){console.log(s),i.loadMoreBtn.hidden=!0,h("Failed to load artists. Please try again later.","error")}finally{M(A),i.loadMoreBtn.disabled=!1,i.loadMoreBtn.removeAttribute("aria-busy"),p=!1}}}function X(e,s,t,o){if(!e)return!1;const r=e.pagination||e.meta||e.pageInfo,n=(r==null?void 0:r.totalPages)??e.totalPages??e.pages??e.total_pages;if(Number.isFinite(n))return s<n;const a=(r==null?void 0:r.hasNextPage)??e.hasNextPage;if(typeof a=="boolean")return a;const c=(r==null?void 0:r.nextPage)??e.nextPage;if(Number.isFinite(c))return c>s;const f=(r==null?void 0:r.total)??(r==null?void 0:r.totalItems)??e.total??e.totalItems??e.totalCount??e.totalArtists;return Number.isFinite(f)?s*t<f:o===t}function H(e){var c;const s=e._id,t=e.strArtist,o=e.strBiographyEN||"",r=o.length>120?`${o.slice(0,120)}...`:o,n=((c=e.genres)==null?void 0:c.slice(0,4))||[];return`
    <li class="artist-card">
      ...
      <div class="artist-card-content">
        <ul class="artist-card-tags">
          ${n.map(f=>`<li class="artist-card-tag">${f}</li>`).join("")}
        </ul>
