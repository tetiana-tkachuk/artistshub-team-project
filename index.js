import{a as v,i as u,R,S as $}from"./assets/vendor-CJJRgr2I.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const C=10,b=8,N="https://sound-wave.b.goit.study/api",y={GENRES:"/genres",ARTISTS:"/artists",ARTIST_BY_ID:"/artists/",FEEDBACKS:"/feedbacks"};v.defaults.baseURL=N;async function O(){const{data:e}=await v.get(`${y.FEEDBACKS}?limit=${C}&page=1`);return e}async function x(e){const{data:t}=await v.get(`${y.ARTISTS}?limit=${b}&page=${e}`);return t}const w="/artistshub-team-project/assets/sprite-D43eHpaH.svg";function I(e){const t=Math.floor(e/6e4),s=Math.floor(e%6e4/1e3);return`${t}:${s.toString().padStart(2,"0")}`}function j(e){return e.intDiedYear===null?`${e.intFormedYear} - present`:`${e.intFormedYear} - ${e.intDiedYear}`}function P(e){return e.strBiographyEN.split(".").slice(0,2).join(".")+"."}function Q(e){return e.genres.map(t=>`
    <li>
      <button class="artist-short-info-genre-btn">${t}</button>
    </li>`).join("")}function Y(e){return e.albumsList.map(s=>{const o=s.tracks.map(r=>{const n=r.movie===null?"":`
